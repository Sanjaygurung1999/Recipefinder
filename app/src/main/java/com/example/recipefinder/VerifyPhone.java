...
public class VerifyPhone extends AppCompatActivity {
    ...
    private void sendVerificationCode(String mobile,String code) {
                ...
                .addOnCompleteListener(VerifyPhone.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(VerifyPhone.this, last_step_signup.class);
                            intent.putExtra("number",code+number);
